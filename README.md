...
В теории связей есть только связи, но нет никаких типов типов, множеств и элементов.
...
Связь имеет рекурсивное определение.
...
Значение связей это последовательность ссылок на связи, последовательность ссылок на связи это значение связи.
