...
Данная статья является прямым логическим развитием нашей предыдущей [статьи](https://habr.com/ru/companies/deepfoundation/articles/658705/) и призвана поделиться с текущим прогрессом в разработке Теории связей, которую ведет команда Deep.Foundation. В рамках данной статьи будет рассмотрена текущая версия черновика формальной системы "Теории Связей".

* Теория связей разрабатывается как более фундаментальная теория по сравнению с Теорией множеств и Теорий Типов.
...
### Представление понятий Теории множеств в ассоциативной сети дуплетов
