...
Данная статья является прямым логическим развитием нашей предыдущей [статьи](https://habr.com/ru/companies/deepfoundation/articles/658705/) и призвана поделиться с текущим прогрессом в разработке Теории связей, которую ведет команда Deep.Foundation. В рамках данной статьи будет рассмотрена текущая весрия черновика формальной системы "Теории Связей".

Разберем основные понятия и терминоы, используемые в Теории Связей. 

Затем перейдем к описанию Теории Связей в рамках Теории Множеств. 

Далее рассмотрим, как Теория Связей может быть представлена в рамках Теории Типов, используя язык автоматизированных доказательств “coq”. 

В заключении будут подведы итоги и предстааленые направления дальнейшего исследования и развития Теории Связей. 
...
Ачисло это описывает связь в виде последовательности ассоциаций.
...
* Напиcать про доказательства теории связей на coq.
...
По мере развития и дополнения Теории Связи также создавалась её прикладная практическая реализация - DeepLinks...
