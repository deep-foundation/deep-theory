...
* Теория связей разрабатывается как более фундаментальная теория по сравнению с Теорией множеств и Теорий Типов. В то время, как в Теории Типов основными понятиями являются "тип" и "значение", а в Теории Множеств - "множество", "значение", В Теории Связей все сводитьсяединому понятию "связь".
