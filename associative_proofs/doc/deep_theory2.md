...
**БО** - это подмножество ПП (прямого произведения) двух множеств, состоящее из упорядоченных пар.
Таким образом, связи в роли УП (упорядоченные пары), входящие в это БО, являются элементами множества, описывающего данное отношение.
...
#### Связь в роли бинарного отношения агрегирования может описывать множество БОА
