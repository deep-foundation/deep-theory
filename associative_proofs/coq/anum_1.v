...
(* 
  `anum` - это индуктивный тип в Coq для представления ассоциативные числа который является расширением чисел Пеано:
  Они можут быть использован для представления различных структур данных и вычислений,
